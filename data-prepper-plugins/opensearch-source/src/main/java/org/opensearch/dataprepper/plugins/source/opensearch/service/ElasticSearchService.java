...
public class ElasticSearchService {
    ...
    private List<JSONObject> searchIndexes(final ElasticsearchClient client, final String indexList, List<String> fields, final Buffer buffer) {
    ...
    private void searchIndexesForPagination(final ElasticsearchClient client, final String indexList, List<String> fields, List<SortingConfiguration> sorting, int currentBatchSize, long currentSearchAfterValue, Buffer buffer){
    ...
    private String scrollIndexesByIndexAndUrl(ElasticsearchClient client, final String indexList, final String url, final Integer batchSize, final Buffer buffer) {
        List<JSONObject> jsonObjects= null;
    ...
    private boolean deleteScrollId(final ElasticsearchClient client, final String scrollId) {
        try {
    ...
    private SearchResponse getSearchResponse(final ElasticsearchClient client, final String indexList, List<String> fields, List<SortingConfiguration> sorting, final long searchAfter, final Buffer buffer) {
    ...
    private List<IndicesRecord> callCatElasticIndices(final ElasticsearchClient client) throws IOException, ParseException {
