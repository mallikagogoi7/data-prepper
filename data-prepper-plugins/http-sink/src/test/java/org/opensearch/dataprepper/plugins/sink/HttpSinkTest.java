...
public class HttpSinkTest {
    ...
    void setUp() {
        ...
        when(httpSinkConfiguration.getBufferType()).thenReturn(BufferTypeOptions.LOCAL_FILE);
        //when(sinkContext.getTagsTargetKey()).thenReturn("test");
    ...
    private HTTPSink createObjectUnderTest() {
        return new HTTPSink(pluginSetting, httpSinkConfiguration, pluginFactory, pipelineDescription,
                awsCredentialsSupplier,sinkContext);
    }
    @Test
