...
public class OAuthRefreshTokenManagerTest {
    ...
    public void bearer_token_refresh_token_test() throws IOException {
        ...
        final String refreshToken = oAuthRefreshTokenManager.getRefreshToken(bearerTokenOptions);
    ...
    public void bearer_token_refresh_token_expiry_test() throws IOException {
        ...
        final boolean refreshToken = oAuthRefreshTokenManager.isTokenExpired(bearerToken);
