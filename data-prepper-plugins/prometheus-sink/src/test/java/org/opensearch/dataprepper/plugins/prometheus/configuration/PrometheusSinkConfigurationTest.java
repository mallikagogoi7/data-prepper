 ...
 */
package org.opensearch.dataprepper.plugins.prometheus.configuration;
...
public class PrometheusSinkConfigurationTest {
    ...
    void default_worker_test() {
        assertThat(new PrometheusSinkConfiguration().getWorkers(), CoreMatchers.equalTo(1));
    }

    @Test
    void default_codec_test() {
        assertNull(new PrometheusSinkConfiguration().getCodec());
    }
    ...
    void default_buffer_type_test() {
        assertThat(new PrometheusSinkConfiguration().getBufferType(), equalTo(BufferTypeOptions.INMEMORY));
    }
    ...
    void http_sink_pipeline_test_with_provided_config_options() throws JsonProcessingException {
        ...
        assertThat(prometheusSinkConfiguration.getBufferType(),equalTo(BufferTypeOptions.INMEMORY));
